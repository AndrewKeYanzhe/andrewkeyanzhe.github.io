...
![img-description](assets/2025-04-12-Lightroom_vs_darktable/P1123045_photomator.avif){: width="400"}
...
The HDR image produced by Photomator does not suffer from desaturation of the orange areas. **However, shadow details on the jeans is crushed**, and the blue color of the jeans appears oversaturated. 

For comparison, **darktable shows accurate shadow details on the jeans.**
