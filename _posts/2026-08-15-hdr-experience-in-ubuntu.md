...
- **Adapter Experience (Windows vs. Linux)**:
  - On **Windows**, a `Cable Matters DP 1.4 to HDMI 2.1 adapter (Model 201428)` drives `4K 120Hz 4:4:4 10-bit HDR`.
  - On **Linux**, this adapter fails to expose HDR (toggle option does not appear in KDE display settings).
  - **Workaround**: Connected directly via native **RTX 2080 HDMI 2.0b port** to the TV to get HDR recognized.
