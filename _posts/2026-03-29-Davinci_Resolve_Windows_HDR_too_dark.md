...
> So I believe Blackmagic Design can fix this issue by scaling pixel values by 1.25 in a linear colorspace before passing to Windows DWM. I have created a bug report on the Blackmagic Forum [here](https://forum.blackmagicdesign.com/viewtopic.php?f=21&t=234287).
{: .prompt-tip }
